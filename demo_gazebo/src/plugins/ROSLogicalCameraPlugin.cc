...
#include "demo_gazebo/plugins/ROSLogicalCameraPlugin.hh"

#include "demo_gazebo/plugins/ARIAC.hh"
#include "demo_gazebo/LogicalCameraImage.h"
...
void ROSLogicalCameraPlugin::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  ...
  this->imagePub = this->rosnode->advertise<demo_gazebo::LogicalCameraImage>(imageTopic_ros, 1, false);
...
void ROSLogicalCameraPlugin::OnImage(ConstLogicalCameraImagePtr &_msg)
{
    ...
    demo_gazebo::LogicalCameraImage imageMsg;
