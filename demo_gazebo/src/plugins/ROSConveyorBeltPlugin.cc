 ...
 *
*/
#include "demo_gazebo/plugins/ROSConveyorBeltPlugin.hh"
...
bool ROSConveyorBeltPlugin::OnControlCommand(ros::ServiceEvent<
  demo_gazebo::ConveyorBeltControl::Request, demo_gazebo::ConveyorBeltControl::Response> & event)
{
  const demo_gazebo::ConveyorBeltControl::Request& req = event.getRequest();
  demo_gazebo::ConveyorBeltControl::Response& res = event.getResponse();
