...
#include <ros/ros.h>
#include <sdf/sdf.hh>
#include "demo_gazebo/plugins/ROSVacuumGripperPlugin.hh"
#include "demo_gazebo/VacuumGripperControl.h"
#include "demo_gazebo/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    demo_gazebo::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  demo_gazebo::VacuumGripperControl::Request &_req,
  demo_gazebo::VacuumGripperControl::Response &_res)
{
...
{
  demo_gazebo::VacuumGripperState msg;
