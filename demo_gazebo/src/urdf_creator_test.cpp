#include <ros/ros.h>
#include "demo_gazebo/urdf_creator.h"
...
int main(int argc, char **argv)
{
  ...
  pnh.param<std::string>("mesh_resource", mesh_resource, "package://demo_gazebo/meshes/conveyor_objects/gear.stl");
  ...
  std::string parsed_xml = demo::simulation::createObjectURDF("gear", mesh_resource);
  ...
  srv.request.robot_namespace = "demo";
